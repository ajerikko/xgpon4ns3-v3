...
#ifndef XGPON_OLT_OMCI_ENGINE_H
#define XGPON_OLT_OMCI_ENGINE_H
...
/**
 * \ingroup xgpon
 * \brief OMCI Engine at OLT-side. Currently, we just implement the interfaces.
 *
 */
class XgponOltOmciEngine : public XgponOltEngine
{
public:
   ...
   * \param omciPacket OMCI packet from ONU
   */
